...
try {
  ...
  $sql="SELECT * from studentpictures WHERE Sid=$sid";
  $rs=$db->query($sql);
...
<div class="header">
  ...
  <hr>
  <?php if(($db->query("SELECT COUNT(*) FROM studentpictures"))=='0')echo "<h3 class='style'> There are no pictures to view </h3>";?>
...
<div class="text">
<h1><a href="uploadStudentPictures.php">go back</a></h1>
</div>
